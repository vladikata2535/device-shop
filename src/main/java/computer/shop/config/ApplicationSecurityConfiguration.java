...
public class ApplicationSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/warehouse/computers").hasRole(UserRoleEnum.ADMIN.name())
                .antMatchers("/api/warehouse/smartphones").hasRole(UserRoleEnum.ADMIN.name())
                .antMatchers("/api/user/info").hasRole(UserRoleEnum.ADMIN.name())
                .antMatchers("/api/user/info").hasRole(UserRoleEnum.USER.name())
